            ...
            <div className="about">
                ...
                <main className="about__main">
                    ...
                    <div className="about__main_right_side">
                        <img src={require('src/img/team.png')} alt="team" className="about__main_right_side__img" onClick={openPhotograph} style={{cursor: "pointer"}}/>
        ...
        return (
            <div className="about">
                ...
                <main className="about__main">
                    ...
                    <div className="about__main_right_side">
                        <img src={require('src/img/team.png')} alt="team" className="about__main_right_side__img_opened" onClick={openPhotograph} style={{cursor: "pointer"}}/>
                        <Text text="Команда агентства «Дрожжи»" fontSize="xs" color="light_gray" className="about__main_right_side__text"></Text>
                    </div>
                </main>
            </div>
